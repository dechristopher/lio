...
SELECT DISTINCT g.id, g.game_id, g.start_ts, g.end_ts, g.created_at, g.race_to, g.white_score, g.black_score, g.method, g.casual, g.room_id, g.creator_uid, g.white_uid, g.black_uid, g.variant_name, g.variant_group, g.outcome, g.reason, g.starting_ofen, g.moves, g.pgn_object_key FROM games g
